...
import { formatCalendarMonthKey, getCalendarMonth, parseCalendarMonthKey } from "@/lib/korea-date";

function getRouteParam(value: string | string[] | undefined) {
	return Array.isArray(value) ? value[0] : value;
}

export default function SajangEmployeeAttendanceStatisticsScreen() {
	...
	return (
		<AppLayout
			...
			onPressBack={() => {
				...
				router.replace("/sajang/attendance" as Href);
			}}
			title="직원별 출근 현황"
			type="view"
		>
